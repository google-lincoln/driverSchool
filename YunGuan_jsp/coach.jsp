              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href=<%=application.getContextPath()+"/yunguan/coachlist"%>>教练信息查看</a></li>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                       ...
                       <tr>
                              ...
                              <th class="hidden-phone">归属驾校</th>
                              <th class="hidden-phone">教练状态</th>
                          </tr>
                          </thead>
                          <tbody>
            <s:iterator value="coachList"  var="k" >
   				<tr >
								<td>
								<s:property value="#k.tid"/> 															
								</td>
								<td>
								<s:property value="#k.tname"/> 		
								</td>
								<td>
								<s:property value="#k.tphone"/> 
								</td>
								<td>
								<s:property value="#k.dsname"/> 
								</td>
								<td>
								<s:property value="#k.cstate"/> 
								</td>						
